<template><div><p>本节内容主要介绍使用 vue-router 来管理路由，包括应用和路由的设计和配置、页面间跳转、路由鉴权等。然后将上一节拼出来的页面，再拼出来一个完整的 Web 应用叭。</p>
<p>本节内容包括：</p>
<ul>
<li>前端单应用介绍</li>
<li>vue-router 使用介绍</li>
<li>页面划分、路由设计、路由监听</li>
<li>如何进行路由鉴权</li>
</ul>
<p><a href="http://vue-for-everyone.godbasin.com/3/index.html" target="_blank" rel="noopener noreferrer">点击查看最终页面的效果<ExternalLinkIcon/></a>：登录页面随便输入内容就可以</p>
<!--more-->
<p>我们<RouterLink to="/vue/vue-for-everyone/vue-for-everyone-1.html">第一节内容</RouterLink>里，最后用<a href="https://cli.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">Vue CLI<ExternalLinkIcon/></a>生成了一个 demo，我们称之为一个 Web 应用。</p>
<h1 id="单页应用" tabindex="-1"><a class="header-anchor" href="#单页应用" aria-hidden="true">#</a> 单页应用</h1>
<p>单页应用这个概念，是随着前几年 AngularJS、React、Ember 等这些框架的出现而出现的。<RouterLink to="/vue/vue-for-everyone/vue-for-everyone-1.html">第一节内容</RouterLink>里，我们在页面渲染中讲了页面的局部刷新，而单页应用则是使用了页面的局部刷新的能力，在切换页面的时候刷新页面内容，从而获取更好的体验。</p>
<h2 id="spa-与-mpa" tabindex="-1"><a class="header-anchor" href="#spa-与-mpa" aria-hidden="true">#</a> SPA 与 MPA</h2>
<p>单页应用（SinglePage Web Application，SPA）和多页应用（MultiPage Application，MPA）的区别可以参考：</p>
<table>
<thead>
<tr>
<th>-</th>
...
<tr>
<td>搜索引擎优化(SEO)</td>
<td>需要单独方案、实现较为困难、不利于 SEO 检索 可利用服务器端渲染(SSR)优化</td>
<td>实现方法简易</td>
</tr>
</tbody>
</table>
<blockquote>
<p>以上表格内容来自<a href="https://juejin.im/post/5a0ea4ec6fb9a0450407725c" target="_blank" rel="noopener noreferrer">《前端：你要懂的单页面应用和多页面应用》<ExternalLinkIcon/></a>，个人认为整理得挺到位的。</p>
</blockquote>
<h2 id="其他应用" tabindex="-1"><a class="header-anchor" href="#其他应用" aria-hidden="true">#</a> 其他应用</h2>
<p>所以其实可以看到，应用和页面的关系，可以简单地理解为多个页面拼成一个应用的关系。应用也分很多种噢，前端里最常见的是浏览器中的 Web 应用，除了这个以外，还有<a href="https://developer.mozilla.org/zh-CN/docs/Web/Progressive_web_apps" target="_blank" rel="noopener noreferrer">渐进式 Web 应用（Progressive Web Apps，PWA）<ExternalLinkIcon/></a>，以及原生应用、移动应用。原生应用这些年也有很火的框架出现，像 React Native，Flutter 和 Xamarin 这样的框架允许使用不同于每种标准本地语言的语言来开发所有平台的本地应用程序。</p>
<p>从产品的角度来说，一个应用可以理解为给用户提供一套完整的定向服务，会包括用户登录、服务分类（Tab）、交互设计和内容展示等等。从工程项目的角度来看，包括用户身份管理、页面管理、路由管理、应用状态管理等。</p>
<p>这一节内容，我们主要来讲路由管理，也就是会把<RouterLink to="/vue/vue-for-everyone/vue-for-everyone-2.html">上一节内容</RouterLink>中拼好的一个个页面，串成一个完整的应用。</p>
<blockquote>
<p>原谅我脑袋里忽然想起了小虎队的“把你的心我的心，串一串，串一株幸运草，串一个同心圆”</p>
</blockquote>
<h1 id="页面划分" tabindex="-1"><a class="header-anchor" href="#页面划分" aria-hidden="true">#</a> 页面划分</h1>
<p>在直接讲我们的路由怎么配置前，我们需要先知道我们的应用要怎么划分，路由和页面路径是一一对应的，所以我们需要先设计应用的页面逻辑。我们要知道怎么设计一个应用，或者说根据已有的产品、设计交互，怎么规划我们项目的结构。</p>
<p>我们看看上一节的<a href="http://vue-for-everyone.godbasin.com/2/index.html" target="_blank" rel="noopener noreferrer">页面效果<ExternalLinkIcon/></a>：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/vue-for-everyone-2-1.jpg" alt=""></p>
<h2 id="页面结构设计" tabindex="-1"><a class="header-anchor" href="#页面结构设计" aria-hidden="true">#</a> 页面结构设计</h2>
<p>这是常用的一种管理端页面结构，我们可以基于这样的页面设计几种类型的页面拼装：</p>
<table>
<thead>
<tr>
<th>序号</th>
...
<p>上述 2-4 结构的页面，可以配合路由，整理出这样的菜单信息：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/vue-for-everyone-3-2.jpg" alt=""></p>
<h2 id="页面路由设计" tabindex="-1"><a class="header-anchor" href="#页面路由设计" aria-hidden="true">#</a> 页面路由设计</h2>
<p>上述情况下，以<code v-pre>/</code>作为根路由（对应的组件为 App.vue），我们设计这么几种路由和页面：</p>
<table>
<thead>
<tr>
<th>路由</th>
...
<tbody>
<tr>
<td><code v-pre>/login</code></td>
<td>登录页</td>
<td>Login</td>
<td>表单，包括<code v-pre>username</code>和<code v-pre>password</code></td>
</tr>
<tr>
<td><code v-pre>/home</code></td>
<td>应用首页</td>
<td>Home</td>
<td>左侧菜单<code v-pre>&lt;Menu&gt;</code>，右侧路由内容<code v-pre>&lt;router-view&gt;</code></td>
</tr>
<tr>
<td><code v-pre>/home/service</code></td>
<td>服务信息页</td>
<td>Service</td>
<td>为 Home 的子路由组件，包括列表和表单</td>
</tr>
<tr>
<td><code v-pre>/home/product</code></td>
<td>产品容器页</td>
<td>Product</td>
<td>为 Home 的子路由组件，包括<code v-pre>&lt;router-view&gt;</code></td>
</tr>
<tr>
<td><code v-pre>/home/product/list</code></td>
<td>产品信息页</td>
<td>ProductList</td>
<td>为 Product 的子路由组件，包括列表</td>
</tr>
<tr>
<td><code v-pre>/home/product/edit</code></td>
<td>产品编辑页</td>
<td>ProductEdit</td>
...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>/login                     /home                     /home/service
+------------------+       +-----------------+       +-----------------+
| App              |       | App             |       | App             |
| +--------------+ |       | +-------------+ |       | +-------------+ |
| | Login        | |       | | Home        | |       | | Home        | |
...
+------------------+       +-----------------+       +-----------------+
 ...
 +--) | | | Product     | | | +--) | | | Product        | | | +--) | | | Product        | | |
      ...
      (=′∇`=）画这个图累死俺了
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们能看到，这里包括了层层的路由嵌套关系，我们后面在配置路由的时候也能看到这样的结构。</p>
<h2 id="目录结构划分" tabindex="-1"><a class="header-anchor" href="#目录结构划分" aria-hidden="true">#</a> 目录结构划分</h2>
<p>我们看到上面的路由划分示意图，使用框框框起来的代表一个 Vue component，而在 Vue 中，其实一切皆组件（页面是特殊的组件），那我们要怎么区分页面和组件呢，一般可以使用项目目录来简单做一些划分：</p>
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>├─dist                      // 编译之后的项目文件
├─src                       // 开发目录
│  ├─assets                 // 静态资源
│     ├─less                // 公共less
│     ├─img                 // 图片资源
...
├─package.json             // 项目配置
├─README.md                // 项目说明
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>目录结构清晰，其实对一个项目的可维护性非常重要，一眼看去你就知道这个项目大概包括了哪些内容，分别都放在哪里。好看的目录结构和命名，和好看的代码结构和命名一样，已经是天然的说明了，这是很好的编码习惯呢。</p>
<p>好了，项目目录和路由结构我们划分好了，我们来看看怎么根据上面的设计来配置路由，以及实现相互跳转吧。</p>
<h1 id="路由配置" tabindex="-1"><a class="header-anchor" href="#路由配置" aria-hidden="true">#</a> 路由配置</h1>
<p>Vue 框架本身的定位是核心关注视图层，所以路由配置、状态管理、其他千奇百怪的测试、mock 功能等都不是自带的，我们需要自己找到对应的开源库配合使用（像 angular 这种大而全的框架，则会提供了开箱即用的完整功能，适合大型项目使用）。例如与 Vue 结合的路由管理，一般选择 <a href="https://router.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-router<ExternalLinkIcon/></a>。</p>
<h2 id="使用开源库和工具" tabindex="-1"><a class="header-anchor" href="#使用开源库和工具" aria-hidden="true">#</a> 使用开源库和工具</h2>
<p>这里顺便介绍下前端怎么找开源库和工具，包括几种途径：</p>
<ol>
<li>google 搜 <code v-pre>vue router</code>。（没有爬墙工具的小伙伴，可以使用 <a href="https://cn.bing.com/" target="_blank" rel="noopener noreferrer">bing<ExternalLinkIcon/></a> 噢）</li>
<li>在 <a href="https://github.com/" target="_blank" rel="noopener noreferrer">github<ExternalLinkIcon/></a> 上搜 <code v-pre>vue router</code>。</li>
<li>去 <a href="https://www.npmjs.com/" target="_blank" rel="noopener noreferrer">npm<ExternalLinkIcon/></a> 上找 <code v-pre>vue router</code> 资源包。（因为前端开源都是基于 npm 包管理，所以基本上都能在 npm 里找到）</li>
</ol>
<p>如图：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/vue-for-everyone-3-1.jpg" alt="搜索开源库和工具"></p>
<h2 id="安装和引入-vue-router" tabindex="-1"><a class="header-anchor" href="#安装和引入-vue-router" aria-hidden="true">#</a> 安装和引入 vue-router</h2>
<p>其实官方文档也有介绍怎么安装和使用，这里再简单介绍一下哈：</p>
<h3 id="_1-安装依赖" tabindex="-1"><a class="header-anchor" href="#_1-安装依赖" aria-hidden="true">#</a> 1. 安装依赖</h3>
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code># 安装依赖
npm install vue-router
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-引入-vue-router" tabindex="-1"><a class="header-anchor" href="#_2-引入-vue-router" aria-hidden="true">#</a> 2. 引入 vue-router</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-vue-router-添加路由" tabindex="-1"><a class="header-anchor" href="#使用-vue-router-添加路由" aria-hidden="true">#</a> 使用 vue-router 添加路由</h2>
<p>这里我们根据前面的应用设计，讲一下要怎么配置，vue-router 怎么使用。</p>
<h3 id="_1-配置路由信息" tabindex="-1"><a class="header-anchor" href="#_1-配置路由信息" aria-hidden="true">#</a> 1. 配置路由信息</h3>
<p>根据以上的嵌套关系，我们可以设置最外层的根路由为<code v-pre>&quot;/&quot;</code>，加上其他嵌套子路由配置为：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 配置路由信息</span>
...
<span class="token keyword">const</span> routes <span class="token operator">=</span> <span class="token punctuation">[</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-vue-中加载-vue-router-和路由信息" tabindex="-1"><a class="header-anchor" href="#_2-vue-中加载-vue-router-和路由信息" aria-hidden="true">#</a> 2. Vue 中加载 vue-router 和路由信息</h3>
<p>路由配置设计好之后，我们可以通过将 router 配置参数注入路由，让整个应用都有路由功能：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 加载路由信息</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里的<a href="https://router.vuejs.org/zh/api/#mode" target="_blank" rel="noopener noreferrer">路由模式-mode<ExternalLinkIcon/></a>包括两种：</p>
<ul>
<li><code v-pre>hash</code>
<ul>
<li>使用 URL hash 值来作路由。支持所有浏览器，包括不支持 HTML5 History Api 的浏览器</li>
<li>例如上面说的<code v-pre>a.com/#/pageone</code>，便是 hash 模式</li>
</ul>
</li>
<li><code v-pre>history</code>
<ul>
<li>充分利用 history.pushState API 来完成 URL 跳转而无须重新加载页面</li>
<li>例如<code v-pre>a.com/pageone</code>，如果觉得 hash 模式丑可以使用这种</li>
<li>**注意！！**依赖 <a href="https://router.vuejs.org/zh/guide/essentials/history-mode.html#html5-history-%E6%A8%A1%E5%BC%8F" target="_blank" rel="noopener noreferrer">HTML5 History API 和服务器配置<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<p>到这里，我们路由配置和启动的部分已经完成，可以在 <a href="https://github.com/godbasin/vue-element-demo/blob/master/3/src/main.js" target="_blank" rel="noopener noreferrer">main.js<ExternalLinkIcon/></a> 文件查看完整代码。</p>
<h3 id="_3-router-view-使用" tabindex="-1"><a class="header-anchor" href="#_3-router-view-使用" aria-hidden="true">#</a> 3. <code v-pre>&lt;router-view&gt;</code>使用</h3>
<p><code v-pre>&lt;router-view&gt;</code>组件是一个 functional 组件，渲染路径匹配到的视图组件。它渲染的组件还可以内嵌自己的<code v-pre>&lt;router-view&gt;</code>，根据嵌套路径，渲染嵌套组件。</p>
<p>我们来看看<code v-pre>&lt;router-view&gt;</code>的使用，这里以<code v-pre>App.vue</code>和<code v-pre>Home.vue</code>作为例子：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 这里是最外层 /app 路由的组件，App.vue --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>el-container</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-router-link-使用" tabindex="-1"><a class="header-anchor" href="#_4-router-link-使用" aria-hidden="true">#</a> 4. <code v-pre>&lt;router-link&gt;</code>使用</h3>
<p><RouterLink to="/vue/vue-for-everyone/vue-for-everyone-2.html">上一节内容</RouterLink>中我们拼了这么一个页面：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/vue-for-everyone-2-1.jpg" alt=""></p>
<p>大家<a href="http://vue-for-everyone.godbasin.com/2/index.html" target="_blank" rel="noopener noreferrer">查看页面效果<ExternalLinkIcon/></a>的时候会发现，左侧的菜单点击没有什么反应，因为我们还没有加上路由。那么现在就使用这里的菜单，来展示下<code v-pre>&lt;router-link&gt;</code>的使用吧。</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 这里是 Menu.vue，即上一节内容种拼的左侧菜单 --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>&lt;router-link&gt;</code>的使用，除了通过 name 来跳转之外，还可通过 path 跳转、带上参数、激活样式、tag 设置等：</p>
<ul>
<li>to: 一个路径字符串, 或者一个对象 location descriptor</li>
<li>tag: 渲染成的 html 元素类型，默认是</li>
<li>exact: 用于控制当前激活项的行为</li>
<li>append: 控制相对链接路径的追加方式</li>
<li>replace: 替代而不是作为历史条目压榨</li>
<li>active-class: 当链接项激活时增加的 CSS 样式</li>
</ul>
<p>更多的大家可以参考<a href="https://router.vuejs.org/zh/api/#router-link" target="_blank" rel="noopener noreferrer">官网 router-link API<ExternalLinkIcon/></a>。也可以在 <a href="https://github.com/godbasin/vue-element-demo/blob/master/3/src/components/Menu.vue" target="_blank" rel="noopener noreferrer">Menu.vue<ExternalLinkIcon/></a> 文件查看 Menu 组件的完整代码。</p>
<h3 id="_5-使用-watch-监控路由变化" tabindex="-1"><a class="header-anchor" href="#_5-使用-watch-监控路由变化" aria-hidden="true">#</a> 5. 使用 watch 监控路由变化</h3>
<p>对应的，我们需要在 menus 里加上 routerName，用来跳转：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// routerName 为对应的路由的路由名称</span>
...
<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">map</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">x<span class="token punctuation">,</span> i</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>根据<a href="https://element.eleme.io/#/zh-CN/component/menu#menu-attribute" target="_blank" rel="noopener noreferrer">el-menu 的配置<ExternalLinkIcon/></a>我们知道，<code v-pre>&lt;el-menu&gt;</code>的<code v-pre>default-active</code>属性需要设置当前激活菜单的 index，因此我们需要监控路由的变化，并根据路由情况调整绑定的激活 index。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 下面是 Vue 组件</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们看到，这里使用了一个叫 watch 的属性。Vue 中监听属性 watch 和计算属性 computed 也是很常用的能力（能节省不少的代码），衍生的其他依赖状态就可以使用 computed 来处理，而某种状态的变更可以使用 watch 监听。这里篇幅关系不多说，大家可以去翻阅下<a href="(https://cn.vuejs.org/v2/guide/computed.html)">官方文档</a>。</p>
<h3 id="_6-路由跳转" tabindex="-1"><a class="header-anchor" href="#_6-路由跳转" aria-hidden="true">#</a> 6. 路由跳转</h3>
<p>除了使用<code v-pre>&lt;router-link&gt;</code>来定义导航链接，我们还可以借助 router 的实例方法，通过编写代码来实现。在 Vue 实例内部，我们可以通过 $router 访问路由实例，例如我们在 ProductList 页面需要跳转到 ProductEdit 页面来编辑/新增选项内容：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>router 实例的使用和<code v-pre>&lt;router-link&gt;</code>其实很相像，也挺简单的，可以参考<a href="https://router.vuejs.org/zh/guide/essentials/navigation.html" target="_blank" rel="noopener noreferrer">编程式的导航<ExternalLinkIcon/></a>。</p>
<h2 id="给路由添加鉴权" tabindex="-1"><a class="header-anchor" href="#给路由添加鉴权" aria-hidden="true">#</a> 给路由添加鉴权</h2>
<p>既然我们这一次设计了登录页和应用首页（请各位根据<RouterLink to="/vue/vue-for-everyone/vue-for-everyone-2.html">第二节内容</RouterLink>分别自行拼出来），一般来说，我们会设计只有当登录完成之后，才可以进入应用里面的其他页面。</p>
<h3 id="_1-设置简单的全局数据" tabindex="-1"><a class="header-anchor" href="#_1-设置简单的全局数据" aria-hidden="true">#</a> 1. 设置简单的全局数据</h3>
<p>一般来说，在 Vue 中会使用 Vuex 来管理数据状态。基于本节内容主要讲 vue-router，所以我们简单设计一个全局数据的管理库：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// globalData.js</span>
...
<span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">clearGlobalData</span><span class="token punctuation">(</span><span class="token parameter">key</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> globalData<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用这种方式的全局数据，是会在页面刷新之后丢失的。而如果用来存用户的登录态信息，为了避免频繁登录，更好的方式是存到 cookie 或者缓存里。</p>
<h3 id="_2-登录页面登录" tabindex="-1"><a class="header-anchor" href="#_2-登录页面登录" aria-hidden="true">#</a> 2. 登录页面登录</h3>
<p>拼好的页面可以查看 <a href="https://github.com/godbasin/vue-element-demo/blob/master/3/src/pages/Login.vue" target="_blank" rel="noopener noreferrer">Login.vue<ExternalLinkIcon/></a> 文件，这里由于篇幅关系，我们只看保存数据和跳转的部分：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> setGlobalData <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"utils/globalData"</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-鉴权进入内页" tabindex="-1"><a class="header-anchor" href="#_3-鉴权进入内页" aria-hidden="true">#</a> 3. 鉴权进入内页</h3>
<p>这里，我们需要使用 vue-router 的<a href="https://router.vuejs.org/zh/guide/advanced/navigation-guards.html#%E5%85%A8%E5%B1%80%E5%89%8D%E7%BD%AE%E5%AE%88%E5%8D%AB" target="_blank" rel="noopener noreferrer">导航守卫<ExternalLinkIcon/></a>能力，当用户未登录时，则拒绝进入其他路由页面里：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// main.js</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到这里，我们整个应用可以顺利地跑起来了：</p>
<ul>
<li><a href="http://vue-for-everyone.godbasin.com/3/index.html" target="_blank" rel="noopener noreferrer">页面的效果查看<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/godbasin/vue-element-demo/tree/master/3" target="_blank" rel="noopener noreferrer">页面代码查看<ExternalLinkIcon/></a></li>
</ul>
<h1 id="结束语" tabindex="-1"><a class="header-anchor" href="#结束语" aria-hidden="true">#</a> 结束语</h1>
<p>很多人会谈到程序员的天花板，前端开发也喜欢谈前端开发的天花板。我们总以为自己所经历的是最艰难的，其实每个人都是一样的。工地的建筑工人、快递外卖小哥、各行各业都有各自的难处，人只要想要往上走，总是要爬坡的。<br>
自我感动取之便捷，又容易上瘾，我们绝不能走到半山腰上就嚎啕大哭。</p>
</div></template>
