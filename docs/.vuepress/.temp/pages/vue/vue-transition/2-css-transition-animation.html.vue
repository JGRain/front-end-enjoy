<template><div><p>该系列用于记录一些使用方法、demo 以及原理分析。本文在 Vue 中使用 CSS 过渡、 CSS 动画的方式来实现动画效果。</p>
<!--more-->
<h1 id="css-过渡与动画" tabindex="-1"><a class="header-anchor" href="#css-过渡与动画" aria-hidden="true">#</a> CSS 过渡与动画</h1>
<p>来，我们先认识下 CSS 过渡。</p>
<h2 id="css-transition" tabindex="-1"><a class="header-anchor" href="#css-transition" aria-hidden="true">#</a> CSS transition</h2>
<p>CSS transitions 提供了一种在更改 CSS 属性时控制动画速度的方法。 其可以让属性变化成为一个持续一段时间的过程，而不是立即生效的。比如，将一个元素的颜色从白色改为黑色，通常这个改变是立即生效的，使用 CSS transitions 后该元素的颜色将逐渐从白色变为黑色，按照一定的曲线速率变化。这个过程可以自定义。</p>
<p>通常将两个状态之间的过渡称为隐式过渡（implicit transitions），因为开始与结束之间的状态由浏览器决定。</p>
<h3 id="transition-使用" tabindex="-1"><a class="header-anchor" href="#transition-使用" aria-hidden="true">#</a> transition 使用</h3>
<p>CSS transitions 可以决定哪些属性发生动画效果 (明确地列出这些属性)，何时开始 (设置 delay），持续多久 (设置 duration) 以及如何动画 (定义 timing funtion，比如匀速地或先快后慢)。</p>
<p>CSS 过渡 由简写属性 transition 定义是最好的方式：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="property" tabindex="-1"><a class="header-anchor" href="#property" aria-hidden="true">#</a> property</h4>
<p>指定哪个或哪些 CSS 属性用于过渡。只有指定的属性才会在过渡中发生动画，其它属性仍如通常那样瞬间变化。all 则为全部属性。</p>
<h4 id="duration" tabindex="-1"><a class="header-anchor" href="#duration" aria-hidden="true">#</a> duration</h4>
<p>指定过渡的时长。或者为所有属性指定一个值，或者指定多个值，为每个属性指定不同的时长。</p>
<h4 id="timing-function" tabindex="-1"><a class="header-anchor" href="#timing-function" aria-hidden="true">#</a> timing-function</h4>
<p>指定一个函数，定义属性值怎么变化。常用如 linear、ease，更多可参考<a href="http://easings.net/zh-cn" target="_blank" rel="noopener noreferrer">缓动函数<ExternalLinkIcon/></a>。</p>
<h4 id="delay" tabindex="-1"><a class="header-anchor" href="#delay" aria-hidden="true">#</a> delay</h4>
<p>指定延迟，即属性开始变化时与过渡开始发生时之间的时长。</p>
<p>下面的简写和不简写的例子：</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.short-for-transition</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>关于每一个属性的详情，可以参考<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions" target="_blank" rel="noopener noreferrer">CSS transition | MDN<ExternalLinkIcon/></a>。</p>
<h2 id="vue-与-css-transition" tabindex="-1"><a class="header-anchor" href="#vue-与-css-transition" aria-hidden="true">#</a> Vue 与 CSS transition</h2>
<h3 id="简单的-demo" tabindex="-1"><a class="header-anchor" href="#简单的-demo" aria-hidden="true">#</a> 简单的 demo</h3>
<p>上面我们已经大概讲了 CSS transition 的使用方式，这里与 Vue 的结合也变得很简单，我们还是看官方的例子：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="过渡的类名" tabindex="-1"><a class="header-anchor" href="#过渡的类名" aria-hidden="true">#</a> 过渡的类名</h3>
<p>我们在 transition 上设置了 name 的值为 fade，然后效果是 Vue 匹配对应的 fade-status 的类名。我们先来看看 Vue 里面提供了哪些类名：</p>
<ul>
<li><strong>v-enter</strong>：定义进入过渡的开始状态。
<ul>
<li>在元素被插入时生效，在下一个帧移除。</li>
</ul>
</li>
<li><strong>v-enter-active</strong>：定义过渡的状态。
<ul>
<li>在元素整个过渡过程中作用，在元素被插入时生效，在 transition/animation 完成之后移除。</li>
<li>这个类可以被用来定义过渡的过程时间，延迟和曲线函数。</li>
</ul>
</li>
<li><strong>v-enter-to</strong>: (2.1.8 版及以上)定义进入过渡的结束状态。
<ul>
<li>在元素被插入一帧后生效 (与此同时 v-enter 被删除)，在 transition/animation 完成之后移除。</li>
</ul>
</li>
<li><strong>v-leav</strong>e: 定义离开过渡的开始状态。
<ul>
<li>在离开过渡被触发时生效，在下一个帧移除。</li>
</ul>
</li>
<li><strong>v-leave-active</strong>：定义过渡的状态。
<ul>
<li>在元素整个过渡过程中作用，在离开过渡被触发后立即生效，在 transition/animation 完成之后移除。</li>
<li>这个类可以被用来定义过渡的过程时间，延迟和曲线函数。</li>
</ul>
</li>
<li><strong>v-leave-to</strong>: (2.1.8 版及以上)定义离开过渡的结束状态。
<ul>
<li>在离开过渡被触发一帧后生效 (与此同时 v-leave 被删除)，在 transition/animation 完成之后移除。</li>
</ul>
</li>
</ul>
<p>文字很多，读起来有点费力气，是时候贴上官网的这个图了：</p>
<p>2.1.8 版本前：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/transition.png" alt="image"></p>
<p>2.1.8 版及以上：
<img src="https://github-imglib-1255459943.cos.ap-chengdu.myqcloud.com/transition2.1.8.png" alt="image"></p>
<h3 id="实现逻辑" tabindex="-1"><a class="header-anchor" href="#实现逻辑" aria-hidden="true">#</a> 实现逻辑</h3>
<p>上一节<a href="">《Vue2 动画 1--transition 组件》</a>我们简单介绍了一些实现原理相关的函数和事件，这里我们再详细分析下。</p>
<p>根据上一节，我们获得以下的信息：</p>
<ul>
<li>可以使用 requestAnimationFrame 来请求浏览器在下一次重绘之前调用指定的函数来更新动画</li>
<li>当 CSS transition 结束时，会触发 transitionend 事件</li>
</ul>
<p>所以结合之前的猜想和 Vue 的源码，能大概得到这里的实现方式：</p>
<ol>
<li>transition 组件关注子元素是否展示，包括使用 v-if/v-else/v-for 等指令绑定数据生成的元素。</li>
<li>当元素状态变更（display -&gt; none 或 none -&gt; display）时，预埋的钩子检测是否应用了 CSS 过渡。</li>
<li>若使用了 CSS 过渡，则分两种情况讨论。</li>
</ol>
<h4 id="进入动画" tabindex="-1"><a class="header-anchor" href="#进入动画" aria-hidden="true">#</a> 进入动画</h4>
<p>当新元素插入时，我们按照以下方式实现进入动画：</p>
<ul>
<li>当元素插入完成后（mounted），给元素添加对应 v-enter 和 v-enter-active 类名，此时元素开始动画过渡</li>
<li>同时通过 requestAnimationFrame 来指定下一帧绘制前，给元素添加 v-enter-to 类名，同时移除 v-enter 类名</li>
<li>设置动画结束时间，或者通过 transitionend 事件监听，在过渡结束后，移除 v-enter-to 和 v-enter-active 类名</li>
</ul>
<h4 id="离开动画" tabindex="-1"><a class="header-anchor" href="#离开动画" aria-hidden="true">#</a> 离开动画</h4>
<p>当新元素被删除时，我们按照以下方式实现离开动画：</p>
<ul>
<li>当元素删除前（beforeDestroy），给元素添加对应 v-leave 和 v-leave-active 类名，此时元素开始动画过渡</li>
<li>同时通过 requestAnimationFrame 来指定下一帧绘制前，给元素添加 v-leave-to 类名，同时移除 v-leave 类名</li>
<li>设置动画结束时间，或者通过 transitionend 事件监听，在过渡结束后，移除 v-leave-to 和 v-leave-active 类名，同时执行元素删除操作</li>
</ul>
<p>以上是整体实现方式，可见在我们使用 CSS 过渡的时候，最关键的是 v-enter-active 和 v-leave-active 两个样式。</p>
<p>我们来看看 Vue 里面的部分代码：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// start enter transition</span>
<span class="token keyword">if</span> <span class="token punctuation">(</span>expectsCSS<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，完整的 CSS 过渡、相关的钩子等会有更多的考虑和处理，这里只展示核心的实现逻辑部分。</p>
<h2 id="css-animation" tabindex="-1"><a class="header-anchor" href="#css-animation" aria-hidden="true">#</a> CSS animation</h2>
<p>CSS animations 使得可以将从一个 CSS 样式配置转换到另一个 CSS 样式配置。动画包括两个部分:描述动画的样式规则和用于指定动画开始、结束以及中间点样式的关键帧。</p>
<p>创建动画序列，需要使用 animation 属性或其子属性，该属性允许配置动画时间、时长以及其他动画细节。
和 transition 不一样的是，该属性不能配置动画的实际表现，动画的实际表现是由 @keyframes 规则实现。</p>
<h3 id="使用-animation" tabindex="-1"><a class="header-anchor" href="#使用-animation" aria-hidden="true">#</a> 使用 animation</h3>
<p>我们来看看 animation 的使用方式，其实跟 transition 很相像的，子属性如下：</p>
<ul>
...
<p>同样的，CSS animation 属性也是一个简写属性形式:</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token comment">/* @keyframes duration | timing-function | delay |
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们也可以用详细的子属性方式来写，这里就不详细描述啦。</p>
<h3 id="关键帧动画" tabindex="-1"><a class="header-anchor" href="#关键帧动画" aria-hidden="true">#</a> 关键帧动画</h3>
<p>一旦完成动画的时间设置， 接下来就需要定义动画的表现。</p>
<p>通过使用 @keyframes 建立两个或两个以上关键帧来实现。每一个关键帧都描述了动画元素在给定的时间点上应该如何渲染。</p>
<p>因为动画的时间设置是通过 CSS 样式定义的，<strong>关键帧使用 percentage 来指定动画发生的时间点。0%表示动画的第一时刻，100%表示动画的最终时刻。<strong>因为这两个时间点十分重要，所以还有特殊的别名：<strong>from</strong>和</strong>to</strong>。</p>
<p>当然，也可包含额外可选的关键帧，描述动画开始和结束之间的状态。</p>
<p>来看个云在天上飘来飘去的 demo：</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.clouldmove</span> <span class="token punctuation">{</span>
...
<span class="token atrule"><span class="token rule">@keyframes</span> ClouldMove</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还有很多的动画效果，包括轮回播放、来回运动等，这里不详细说明，大家感兴趣可以参考<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_Animations/Using_CSS_animations" target="_blank" rel="noopener noreferrer">《使用 CSS 动画 | MDN》<ExternalLinkIcon/></a>。总之要记住，CSS animation 是个超级变态的动画效果实现。</p>
<h3 id="animation-事件监听器" tabindex="-1"><a class="header-anchor" href="#animation-事件监听器" aria-hidden="true">#</a> animation 事件监听器</h3>
<p>上面我们讲到了 transitionend，animation 比它还多了些事件。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// animationstart事件在动画一开始时就被触发</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-与-animation" tabindex="-1"><a class="header-anchor" href="#vue-与-animation" aria-hidden="true">#</a> Vue 与 animation</h3>
<p>对于 Vue 来说，不管是 transition 还是 animation，都是通过 CSS 和类名来实现动画的，所以基本逻辑原理相似，除去动画结束监听的事件不一样而已。</p>
<p>这里就不多描述啦。</p>
<h1 id="结束语" tabindex="-1"><a class="header-anchor" href="#结束语" aria-hidden="true">#</a> 结束语</h1>
<p>本节我们介绍了 Vue 中组件 CSS 过渡和 CSS 动画的使用方式，以及实现逻辑的分析。很多时候，我们的工作时间限制了自己手动造轮子的能动性，但是思路的整理和部分源码的分析也能帮助我们来提升自己。</p>
</div></template>
